...
enum NotchHoverTests {
    ...
    static func run(_ suite: TestSuite) {
        ...
        active.hover(true)
        DispatchQueue.main.advance(0.26)
        suite.expect(active.openings == 1 && active.requestedModule == nil,
        ...
        DispatchQueue.main.advance(1)
        suite.expect(keyboard.closures == 0, "moving to the Accessibility Keyboard preserves the working panel")
    }
}
